      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            className="rounded-full bg-forest px-5 py-2 text-sm font-semibold text-cream transition-[background-color,box-shadow] duration-300 hover:bg-forest-deep hover:shadow-lg hover:shadow-forest/20"
          >
            Começar agora
          </a>
        </div>

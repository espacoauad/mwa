...
export const versiculos = [
  ...
  // DIAS 91-111: PERMANÊNCIA E CONTINUAÇÃO - Amar, cuidar, contribuir para sempre
  {
    dia: 91,
    texto: "Porque o que começou em você será completo até o fim.",
    referencia: "Filipenses 1:6",
    tema: "Obra contínua",
    reflexao: "Este não é o fim — é apenas o começo de uma vida inteira de cuidado consigo mesma."
  },
  {
    dia: 92,
    texto: "Não pense que chegou ao fim. Este é apenas o começo do resto de sua vida.",
    referencia: "Apocalipse 21:5",
    tema: "Novo começo",
    reflexao: "O melhor ainda está por vir. Você está apenas no capítulo 1 da sua história de transformação."
  },
  {
    dia: 93,
    texto: "Porque o amor que você cultivou em si mesmo deve transborduar para outros.",
    referencia: "João 13:34-35",
    tema: "Amor transbordante",
    reflexao: "Quando você se ama, seu amor transborda. Compartilhe sua transformação com generosidade."
  },
  {
    dia: 94,
    texto: "Continue firme na decisão que tomou. As raízes já estão fundas.",
    referencia: "Colossenses 2:7",
    tema: "Raízes profundas",
    reflexao: "Você não é um iniciante mais. Suas raízes de saúde estão profundas. Nenhuma tempestade a derrubará."
  },
  {
    dia: 95,
    texto: "Porque agora você conhece seu próprio poder. Compartilhe-o.",
    referencia: "Mateus 5:16",
    tema: "Compartilhamento",
    reflexao: "Seu poder não é privado. Compartilhe o que aprendeu. Seja um exemplo vivo para outros."
  },
  {
    dia: 96,
    texto: "A vida é um presente contínuo. Cuide dela como se fosse sagrada.",
    referencia: "Salmos 118:24",
    tema: "Sacralidade da vida",
    reflexao: "Cada dia é um novo presente. Trate-o como sagrado. Proteja essa vida que você criou."
  },
  {
    dia: 97,
    texto: "Porque você não apenas cuida de si, mas se torna exemplo para outros.",
    referencia: "1 Timóteo 4:12",
    tema: "Exemplo vivo",
    reflexao: "Você é um exemplo agora. Sua transformação fala mais alto que palavras. Continue brillando."
  },
  {
    dia: 98,
    texto: "Continue comendo alimento que nutra seu corpo e sua alma.",
    referencia: "Deuteronômio 8:3",
    tema: "Alimentação sábia",
    reflexao: "Alimento é mais que calorias — é energia, é amor, é cuidado. Escolha sempre o que nutre."
  },
  {
    dia: 99,
    texto: "Porque cada dia é uma chance de amar mais, cuidar mais, contribuir mais.",
    referencia: "Colossenses 3:17",
    tema: "Oportunidade diária",
    reflexao: "Você não chegou ao topo. Cada dia é uma chance de amar ainda mais — a si mesma e aos outros."
  },
  {
    dia: 100,
    texto: "Que sua transformação inspire transformação em outros.",
    referencia: "2 Coríntios 3:18",
    tema: "Transformação multiplicada",
    reflexao: "100 dias! Sua transformação inspirou quantas pessoas? Continue sendo essa inspiração."
  },
  {
    dia: 101,
    texto: "Porque o Senhor diz: Minha graça é suficiente. Você também é suficiente.",
    referencia: "2 Coríntios 12:9",
    tema: "Suficiência",
    reflexao: "Você não precisa ser mais, fazer mais, ter mais. Você já é suficiente. Acredite nisso."
  },
  {
    dia: 102,
    texto: "Continue perseverando. A coroa da vida espera por você.",
    referencia: "Tiago 1:12",
    tema: "Perseverança final",
    reflexao: "Nove dias restam. Termine forte. A coroa que você merece está esperando."
  },
  {
    dia: 103,
    texto: "Porque agora você sabe: toda dificuldade é uma oportunidade de crescer.",
    referencia: "Tiago 1:2-3",
    tema: "Crescimento através das dificuldades",
    reflexao: "As dificuldades que você superou a tornaram mais forte. Aprecie cada uma delas."
  },
  {
    dia: 104,
    texto: "Que a sua vida seja oferenda. Viva com intenção.",
    referencia: "Romanos 12:1",
    tema: "Vida como oferenda",
    reflexao: "Sua vida é uma oferenda. Viva com intenção. Cada ação é um presente para você mesma."
  },
  {
    dia: 105,
    texto: "Porque você aprendeu a amar seu corpo. Nunca deixe de aprender.",
    referencia: "Provérbios 18:15",
    tema: "Aprendizado contínuo",
    reflexao: "O aprendizado nunca termina. Continue explorando, curiosa, descobrindo novos jeitos de amar seu corpo."
  },
  {
    dia: 106,
    texto: "Cada refeição é um ato de cuidado. Cada movimento é um ato de amor.",
    referencia: "1 Coríntios 10:31",
    tema: "Sagrado no cotidiano",
    reflexao: "Não há ato pequeno demais. Cada comida, cada passo é uma declaração de amor por si mesma."
  },
  {
    dia: 107,
    texto: "Porque você não caminha sozinha. Sua comunidade celebra você.",
    referencia: "Hebreus 10:24-25",
    tema: "Comunidade",
    reflexao: "Você não está sozinha. As pessoas ao seu redor celebram sua transformação. Sinta esse amor."
  },
  {
    dia: 108,
    texto: "Continue plantando sementes de esperança. A colheita virá.",
    referencia: "Eclesiastes 11:6",
    tema: "Esperança na semeadura",
    reflexao: "Você não sabe qual semente crescerá. Mas uma coisa é certa: você seguirá plantando com fé."
  },
  {
    dia: 109,
    texto: "Porque o maior legado é o cuidado que você deixa consigo e com outros.",
    referencia: "Provérbios 27:12",
    tema: "Legado de cuidado",
    reflexao: "Seu legado não será o tamanho do seu jeans. Será a forma como você amou a si mesma e aos outros."
  },
  {
    dia: 110,
    texto: "Uma última verdade: Você é digno. Você sempre foi. Agora você sabe.",
    referencia: "Efésios 1:14",
    tema: "Verdade final",
    reflexao: "Você não se tornou digna — você sempre foi. Agora você acredita. Isso é a maior transformação."
  },
  {
    dia: 111,
    texto: "Parabéns! Você completou 111 dias. Agora a vida verdadeira começa: uma vida de propósito, amor, cuidado e contribuição.",
    referencia: "Romanos 6:9-11",
    tema: "Vida eterna renovada",
    reflexao: "111 dias não é o fim. É o começo. Você aprendeu as ferramentas. Agora use-as para viver abundantemente."
  }
]
